...
public class YahooWeatherService {
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (count == 0) {
                        callback.serviceFailure(new LocationWeathereException("No weather information found for \"" + location + "\""));
                        return;
    ...
    public class LocationWeathereException extends Exception {
        public LocationWeathereException(String message) {
            super(message);
        }
    }
}